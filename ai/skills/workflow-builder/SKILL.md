...
description: "Trigger: sdd-govp:workflow-builder, /workflow-builder or workflow, project workflow, flujo de trabajo, workflow builder. Create custom workflows for ANY project type — thesis, consulting, coaching, research, etc. Generates phase skills dynamically."
